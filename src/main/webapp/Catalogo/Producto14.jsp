<%-- 
    Document   : Producto14
    Created on : 10 ago 2025, 1:28:48 p.m.
    Author     : Lendrock
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dwd8eae3a1/images/funko/upload/76110_POPGames_Spiderman2_Venom_GLAM-WEB.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Venom</strong><br>Spider-Man</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "14"; // valor por defecto si no viene el parámetro
                }
            %>

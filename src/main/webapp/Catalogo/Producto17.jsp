...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dw16074ac2/images/funko/upload/80986_POP-Retro-Toys_Trfms-G1_Megatron_POP_GLAM_FIGUREONLY-WEB.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Megatron</strong><br>Transformers</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "17"; // valor por defecto si no viene el parámetro
                }
            %>

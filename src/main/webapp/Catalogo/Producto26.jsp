...
<html lang="es">
    ...
    <div class="Menu">
        <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dw7412cc63/images/funko/56308-1.png?sw=800&sh=800" alt="Chicken Suit">

        <p class="Titule"><strong>Charizard</strong><br>Pokémon</p>

        <%
            // Obtener el parámetro id de la URL
            String idProducto = request.getParameter("id");
            if (idProducto == null) {
                idProducto = "26"; // valor por defecto si no viene el parámetro
            } 
        %>

...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dwe7080fa9/images/funko/upload/85189_POP_StarWars_POP-2_GLAM-WEB.png?sw=800&sh=800" alt="Kylo Ren">

            <p class="Titule"><strong>Kylo Ren</strong><br>Star Wars</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "3"; // valor por defecto si no viene el parámetro
                }
            %>

<%-- 
    Document   : Producto9
    Created on : 08/08/2025, 12:00:14
    Author     : Zacarias
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dw46b7e7b5/images/funko/upload/87189A_Disney_TS30th_Sid_POP_GLAM-WEB.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Sid</strong><br>Toy Story</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "9"; // valor por defecto si no viene el parámetro
                }
            %>

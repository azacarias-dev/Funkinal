<%-- 
    Document   : Producto11
    Created on : 10 ago 2025, 1:13:41 p.m.
    Author     : Lendrock
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dw3440cbe0/images/funko/upload/87224_Marvel_S1_FriendlyNeighborhoodSpider-Man_POP_EDIT_T7_GLAM_Frontview-WEB.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Spider Man</strong><br>Spider-Man</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "11"; // valor por defecto si no viene el parámetro
                }
            %>

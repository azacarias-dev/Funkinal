<%-- 
    Document   : Producto20
    Created on : 10/08/2025, 16:13:43
    Author     : MIGUEL
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dw5b06710c/images/funko/50544-1.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Eevee</strong><br>Pokémon</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "30"; // valor por defecto si no viene el parámetro
                }
            %>

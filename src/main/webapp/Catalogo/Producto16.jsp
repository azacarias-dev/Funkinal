...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dwb742c50e/images/funko/upload/1/86215a_POPTV_Transformers_OptiPrimal_GLAM-WEB.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Optimus Prime</strong><br>Transformers</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "16"; // valor por defecto si no viene el parámetro
                }
            %>

<%-- 
    Document   : Producto28
    Created on : 10/08/2025, 16:13:29
    Author     : MIGUEL
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dwbc4c2281/images/funko/upload/67665_Pokemon_Umbreon_POP_GLAM-WEB.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Umbreon</strong><br>Pokémon</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "28"; // valor por defecto si no viene el parámetro
                }
            %>

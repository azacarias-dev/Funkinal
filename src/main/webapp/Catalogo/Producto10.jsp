<%-- 
    Document   : Producto10
    Created on : 08/08/2025, 12:00:20
    Author     : Zacarias
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dwc546b78f/images/funko/upload/86272_Disney_ToyStory_AlienWClaw_POP_GLAM-WEB.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Alien</strong><br>Toy Story</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "10"; // valor por defecto si no viene el parámetro
                }
            %>

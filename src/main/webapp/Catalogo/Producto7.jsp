<%-- 
    Document   : Producto7
    Created on : 08/08/2025, 12:00:00
    Author     : Zacarias
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dwa03c6ecf/images/funko/37383-1.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Woody</strong><br>Toy Story</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "7"; // valor por defecto si no viene el parámetro
                }
            %>

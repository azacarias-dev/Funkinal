<%-- 
    Document   : Producto12
    Created on : 10 ago 2025, 1:28:13 p.m.
    Author     : Lendrock
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dw857dd967/images/funko/upload/85187_Marvel_S1_GreenGoblin_POP_EDIT_T7_GLAM_FrontView-WEB.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Duende Verde</strong><br>Spider-Man</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "12"; // valor por defecto si no viene el parámetro
                }
            %>

...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dwba9bd9b1/images/funko/upload/84119_Hasbro_Transformers_Cyclonus_POP_Glam-WEB.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Cyclonus</strong><br>Transformers</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "18"; // valor por defecto si no viene el parámetro
                }
            %>

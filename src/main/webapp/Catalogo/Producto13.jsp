<%-- 
    Document   : Producto13
    Created on : 10 ago 2025, 1:28:26 p.m.
    Author     : Lendrock
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dw46a7fe15/images/funko/upload/82110_Marvel_8Bit_DoctorOctopus_POP_GLAM-WEB.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Doctor Octopus</strong><br>Spider-Man</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "13"; // valor por defecto si no viene el parámetro
                }
            %>

...
<html lang="es">
    ...
    <body>
        ...
        <div class="Menu">
            <img src="https://funko.com/dw/image/v2/BGTS_PRD/on/demandware.static/-/Sites-funko-master-catalog/default/dwc8dca0a7/images/funko/37390-1.png?sw=800&sh=800" alt="Chicken Suit">

            <p class="Titule"><strong>Buzz Lightyear</strong><br>Toy Story</p>

            <%
                // Obtener el parámetro id de la URL
                String idProducto = request.getParameter("id");
                if (idProducto == null) {
                    idProducto = "8"; // valor por defecto si no viene el parámetro
                }
            %>
